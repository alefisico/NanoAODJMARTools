#include "PhysicsTools/NanoAODJMARTools/interface/NsubjettinessWrapper.h"
#include "fastjet/PseudoJet.hh"

NsubjettinessWrapper::NsubjettinessWrapper(double beta, double R0, double Rcutoff, unsigned measureDefinition, unsigned axesDefinition, int nPass, double akAxesR0 ) :
    beta_(beta), R0_(R0), 
...
NsubjettinessWrapper::NsubjettinessWrapper(double beta, double R0, unsigned measureDefinition, unsigned axesDefinition ) :
    NsubjettinessWrapper::NsubjettinessWrapper( beta, R0, 999., measureDefinition, axesDefinition, 999., 999. )
{}


 
NsubjettinessWrapper::NsubjettinessWrapper() :
    beta_(1), R0_(0.8), 
...
std::vector<double> NsubjettinessWrapper::getTau( unsigned maxTau, std::vector<TLorentzVector> const & particles )
{
